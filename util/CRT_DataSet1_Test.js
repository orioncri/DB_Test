...
//RER            .doctype("City").label("City").parent('Object')
            ...
            .property('cid', 'xsd:integer').label("Cid")
            .property("c_object_id", "xsd:integer").label("City Object Id")
            ,commit_msg
        ).then(response => {
          console.log('# Created City Schema')
          // add the Schema for class 'scm:Person'
          commit_msg = 'Created Person Schema'
...
//RER              .doctype("Person").label("Person").parent('Object')
              ...
              .property('pid', 'xsd:integer').label("Pid")
              .property("p_object_id", "xsd:integer").label("Person Object Id")
              ,commit_msg
          ).then(response => {
            console.log('# Created Person Schema')
            // add the Schema for class 'scm:CityContent'
            commit_msg = 'Created City Content Schema'
...
//RER                .doctype("CityContent").label("City Content").parent('Object')
                ...
                .property('ccid', 'xsd:integer').label("Ccid")
                .property("cityContent_id", "xsd:integer").label("City Content Id")
                .property("ccity_id", "xsd:integer").label("City Id")
              ...
              commit_msg = 'Created Person Content Schema'
...
//RER                  .doctype("PersonContent").label("Person Content").parent('Object')
                  ...
                  .property('pcid', 'xsd:integer').label("Pcid")
                  .property("personContent_id", "xsd:integer").label("Person Content Id")
                  .property("person_id", "xsd:integer").label("Person Id")
                  .property("first_name", "xsd:string").label("First Name")
                  .property("last_name", "xsd:string").label("Last Name")
                  .property("age", "xsd:integer").label("Person Age")
                  .property("pcity_id", "xsd:integer").label("City Id")
                  ,commit_msg
              ).then(() => {
...
const addRevision1 = () => {
  ...
  .then(response => {
    ...
    WOQL.query(Q
        ...
        ,'Main - Add CityContent Revision 1 A2'
    ).then(() => {
  ...
  .then(response => {
    ...
    WOQL.query(Q
        ...
        ,'Main - Add PersonContent Revision 1 A3'
    ).then(() => {
...
const addRevision2 = () => {
  ...
  .then(response => {
    ...
    WOQL.query(Q
        ...
        ,'Main - Add CityContent Revision 2 A4'
    ).then(() => {
  ...
  .then(response => {
    ...
    WOQL.query(Q
        ...
        ,'Main - Add PersonContent Revision 2 A5'
    ).then(() => {
...
const addRevision3 = () => {
  ...
  .then(response => {
    ...
    WOQL.query(Q
            ...
            .add_triple('doc:object4', 'object_type', Q.literal('City', 'xsd:string'))
            ,'Branch_3_5 - Add Object Revision 3 A6'
    ).then(() => {
        ...
        WOQL.query(Q
            ...
            .add_triple('doc:object5', 'object_type', Q.literal('Person', 'xsd:string'))
            ,'Branch_3_5 - Add Object Revision 3 A7'
        ).then(() => {
  ...
  .then(response => {
    ...
    WOQL.query(Q
        ...
        ,'Branch_3_5 - Add City Revision 3 A6'
    ).then(() => {
  ...
  .then(response => {
    ...
    WOQL.query(Q
        ...
        ,'Branch_3_5 - Add CityContent Revision 3 A6'
    ).then(() => {
  ...
  .then(response => {
    ...
    WOQL.query(Q
        ...
        ,'Branch_3_5 - Add Person Revision 3 A7'
    ).then(() => {
  ...
  .then(response => {
    ...
    WOQL.query(Q
            ...
            ,'Branch_3_5 - Add PersonContent Revision 3 A7'
    ).then(() => {
...
const addRevision4 = () => {
  ...
  .then(response => {
    ...
    WOQL.query(Q
        ...
        ,'Main - Add PersonContent Revision 4 A8'
    ).then(() => {
  ...
  .then(response => {
    ...
    WOQL.query(Q
        ...
        .add_triple('doc:personContent2', 'first_name', Q.literal('Kelley', 'xsd:string'))
        ,'Main - Change PersonContent Revision 4 C1'
    ).then(() => {
...
const addRevision5 = () => {
  ...
  .then(response => {
    console.log('# Change CityContent Revision 5 C2')
    WOQL.query(Q
        .delete_triple('doc:cityContent1', 'name', 'v:City Name')
        .add_triple('doc:cityContent1', 'name', Q.literal('Fort worth', 'xsd:string'))
        ,'Branch_3_5 - Change CityContent Revision 5 C2'
    ).then(() => {
        console.log('# Changed CityContent Revision 5 C2')
    }).catch(error => console.log('Change CityContent Revision 5 C2 error', error))
  }).catch(error => console.log('CityContent Schema error', error))
  ...
  .then(response => {
    ...
    WOQL.query(Q
        ...
        .add_triple('doc:personContent2', 'last_name', Q.literal('Hughes', 'xsd:string'))
        ,'Branch_3_5 - Change PersonContent Revision 5 C3'
    ).then(() => {
...
const addRevision6 = () => {
  ...
  .then(response => {
    ...
    WOQL.query(Q
            ...
            ,'Branch_6_8 - Add Object Revision 6 A9'
    ).then(() => {
  ...
  .then(response => {
    ...
    WOQL.query(Q
        ...
        ,'Branch_6_8 - Add Person Revision 6 A9'
    ).then(() => {
  ...
  .then(response => {
    ...
    WOQL.query(Q
        ...
        ,'Branch_6_8 - Add PersonContent Revision 6 A9'
    ).then(() => {
  ...
  WOQL.query(Q
    ...
    .then(response => {
      console.log('# Change CityContent Revision 6 C4')
      WOQL.query(Q
        .delete_triple('doc:cityContent1', 'name', 'Name')
          .add_triple('doc:cityContent1', 'name', Q.literal('fort Worth', 'xsd:string'))
          ,'Branch_6_8 - Change CityContent Revision 6 C4'
      ).then(() => {
          console.log('# Changed CityContent Revision 6 C4')
      }).catch(error => console.log('Change CityContent Revision 6 C4 error', error))
    }).catch(error => console.log('CityContent Schema error', error))
}
...
const addRevision8 = () => {
  ...
  .then(response => {
    ...
    WOQL.query(Q
        ...
        ,'Branch_6_8 - Change PersonContent Revision 8 C5'
    ).then(() => {
  ...
  WOQL.query(Q
    ...
    .then(response => {
      ...
      WOQL.query(Q
          ...
          ,'Branch_6_8 - Delete Object Revision 8 D1'
      ).then(() => {
  ...
  WOQL.query(Q
    ...
    .then(response => {
      ...
      WOQL.query(Q
          ...
          ,'Branch_6_8 - Delete Person Revision 8 D1'
      ).then(() => {
    ...
    .then(response => {
      ...
      WOQL.query(Q
          .delete_object('doc:personContent1')
          ,'Branch_6_8 - Delete PersonContent Revision 8 D1'
      ).then(() => {
    ...
    .then(response => {
      ...
      WOQL.query(Q
        .delete_triple('doc:cityContent2', 'name', 'Name')
            .add_triple('doc:cityContent2', 'name', Q.literal('Ashtown', 'xsd:string'))
            ,'Main - Change CityContent Revision 10 C6'
      ).then(() => {
