...
const addRevision8 = () => {
  ...
  .then(response => {
    ...
    WOQL.query(Q
        ...
        .comment('Change PersonContent Revision 8 C5')
    ).then(() => {
  ...
  WOQL.query(Q
	  ...
	  .then(response => {
	    console.log('# Delete Object Revision 1 A2')
	    WOQL.query(Q
	            .delete_triple('doc:object3', 'type', 'scm:Object')
	            .delete_triple('doc:object3', 'id', Q.literal(2, 'xsd:integer'))
	            .delete_triple('doc:object3', 'object_type', Q.literal('Person', 'xsd:string'))
	            .comment('Delete Object Revision 1 A2')
	    ).then(() => {
	        console.log('# Deleted Object Revision 1 A2')
	    }).catch(error => console.log('Delete Object Revision A1 error', error))
	  }).catch(error => console.log('Object Schema error', error))

  //TODO Delete Person Duane
  //TODO Delete PersonContents Duane
}
