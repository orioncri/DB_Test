...
//RER					.property('id', 'xsd:integer').label("Id").cardinality(1)
					.property('oid', 'xsd:integer').label("Oid").cardinality(1)
...
const addObjectData = () => {
	...
	.then(response => {
		...
		WOQL.query(Q
				...
				.add_triple('doc:object1', 'oid', Q.literal(0, 'xsd:integer'))
			...
			WOQL.query(Q
					...
					.add_triple('doc:object2', 'oid', Q.literal(1, 'xsd:integer'))
				...
				WOQL.query(Q
						...
						.add_triple('doc:object3', 'oid', Q.literal(2, 'xsd:integer'))
					...
					WOQL.query(Q
							...
							.add_triple('doc:object4', 'oid', Q.literal(3, 'xsd:integer'))
						...
						WOQL.query(Q
								...
								.add_triple('doc:object5', 'oid', Q.literal(4, 'xsd:integer'))
							...
							WOQL.query(Q
									...
									.add_triple('doc:object6', 'oid', Q.literal(5, 'xsd:integer'))
								...
								WOQL.query(Q
										...
										.add_triple('doc:object7', 'oid', Q.literal(6, 'xsd:integer'))
									...
									WOQL.query(Q
											...
											.add_triple('doc:object8', 'oid', Q.literal(7, 'xsd:integer'))
										...
										WOQL.query(Q
												...
												.add_triple('doc:object9', 'oid', Q.literal(8, 'xsd:integer'))
