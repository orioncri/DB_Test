...
const addRevision2 = () => {
  ...
  .then(response => {
    console.log('# Add City Revision 2 A5')
    ...
    WOQL.query(Q
        ...
        .comment('Add City Revision 2 A5')
    ).then(() => {
      console.log('# Added City Revision 2 A5')
    }).catch(error => console.log('City Revision 2 A5 error', error))
  }).catch(error => console.log('Add City Schema error', error))
  ...
  .then(response => {
    console.log('# Add CityContent Revision 2 A5')
    WOQL.query(Q
        ...
        .comment('Add CityContent Revision 2 A5')
    ).then(() => {
        console.log('# Added CityContent Revision 2 A5')
    }).catch(error => console.log('Add CityContent Revision 2 A5 error', error))
  }).catch(error => console.log('CityContent Schema error', error))
